...
CREATE TABLE `egraph_details_base` (
  ...
  `details` longblob DEFAULT NULL COMMENT 'business specific details',
  ...
  `indexes` mediumblob DEFAULT NULL COMMENT 'indexes created within details reside here',
  PRIMARY KEY (`source`),
...
CREATE TABLE `egraph_link_base` (
  ...
  `version` int(4) NOT NULL DEFAULT '0' COMMENT 'contention resolution and for data etag',
  `details_hash` binary(8) DEFAULT '0' COMMENT 'xxhash64 of details',
  `details` longblob DEFAULT NULL COMMENT 'link specific details',
  `updated_datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Datetime when the entry was last updated',
...
CREATE TABLE `egraph_function` (
  ...
  `details` longblob NOT NULL COMMENT 'anonymous function source code',
  `details_hash` binary(8) DEFAULT '0' COMMENT 'xxhash64 of details',
  `test_validator_function` longblob NOT NULL COMMENT 'anonymous function to validate test vectors',
  `test_vectors` longblob NOT NULL COMMENT 'Erlang serialized map of test vectors',
  `updated_datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Datetime when the entry was last updated',
...
CREATE TABLE `egraph_reindex_status` (
  ...
  `details` mediumblob NOT NULL COMMENT 'additional details',
